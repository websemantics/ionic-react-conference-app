...
const Login = ({ setIsLoggedIn, history, setUsername: setUsernameAction }) => {
  ...
  return (React.createElement(IonPage, { id: "login-page" },
    React.createElement(IonHeader, null,
      React.createElement(IonToolbar, null,
        ...
        React.createElement(IonTitle, null, "Login"))),
      ...
      React.createElement("form", { noValidate: true, onSubmit: login },
        React.createElement(IonList, null,
          React.createElement(IonItem, null,
            ...
            React.createElement(IonInput, { name: "username", type: "text", value: username, spellCheck: false, autocapitalize: "off", onIonChange: e => setUsername(e.detail.value), required: true })),
          ...
          React.createElement(IonItem, null,
            ...
            React.createElement(IonInput, { name: "password", type: "password", value: password, onIonChange: e => setPassword(e.detail.value) })),
        ...
        React.createElement(IonRow, null,
          React.createElement(IonCol, null,
            React.createElement(IonButton, { type: "submit", expand: "block" }, "Login")),
          React.createElement(IonCol, null,
            React.createElement(IonButton, { routerLink: "/signup", color: "light", expand: "block" }, "Signup")))))))
}
